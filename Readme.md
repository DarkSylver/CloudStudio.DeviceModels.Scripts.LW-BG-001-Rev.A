...
# Configuration Script – LW-BG-001 - Rev. A

This **Configuration** script is designed for the **LW-BG-001** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – LW-BG-001 Rev. A

Este script de **Configuration** está diseñado para el modelo **LW-BG-001** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
